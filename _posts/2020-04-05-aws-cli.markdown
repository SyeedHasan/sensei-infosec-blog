...
categories: forensics aws cli sensei dfir incident cloud engineer amazon  
---
...
![CLI](/assets/configure-profile.png)
...
![CLI Greetings](/assets/console-greeting.png)
...
![IAM Users](/assets/iam-user-tab.png)

Click on 'Add User' to get started with the registration process:

![IAM Add User](/assets/iam-add-user.png)
...
![IAM Add User](/assets/iam-todo-1.png)
...
![IAM Add User](/assets/iam-todo-2.png)
...
![IAM Add User](/assets/iam-todo-3.png)
...
![IAM Add User](/assets/iam-todo-4.png)
...
![IAM Add User](/assets/iam-todo-5.png)
...
![IAM Add User](/assets/configure-profile-2.png)
...
![Caller Identity](/assets/caller-identity.png)
...
![S3 Command](/assets/s3-command.png)
